...
nanoperl-mini.sh [optional alternate dir for nanoperl-mini]: wrapper for
...
## Fetch the source from a Perl Distribution

sh ./copyfiles.sh filelist_perl-5.7.0.txt  ../perl-5.7.0 sources_perl-5.7.
